...
public class ResourceBundleAPIUsage {
	...
	public static void main(String[] args) {
		...
		ResourceBundle rs = ResourceBundle.getBundle("com.programming.class2.TestBundle");
		displayValues(rs);
		
		
		Locale swedishLocale = new Locale("sv", "SE");
		ResourceBundle rs2 = ResourceBundle.getBundle("com.programming.class2.TestBundle" , swedishLocale);
		displayValues(rs2);
