...
public class WorkWithDatabase {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String insertSQL = "INSERT INTO employee1 VALUES(" +
                    "111,'A','B','Manager')";
            ...
            String updateSQL = "UPDATE employee1 set First_NAME='X',"+
...
//            String deleteSQL = "DELETE FROM employee1 WHERE FIRST_NAME='X'";
